class CreateFedexPakBoxZoneDiscounts < ActiveRecord::Migration[7.0]
  def change
    create_table :fedex_pak_box_zone_discounts do |t|
      t.references :fedex_discount_projection, null: false, foreign_key: true, index: { name: 'idx_fedex_pak_box_zone_disc_on_proj_id' }
