class CreateFedexEnvelopeMinimumCharges < ActiveRecord::Migration[7.0]
  def change
    create_table :fedex_envelope_minimum_charges do |t|
      t.references :fedex_discount_projection, null: false, foreign_key: true, index: { name: 'idx_fedex_env_min_charges_on_proj_id' }
